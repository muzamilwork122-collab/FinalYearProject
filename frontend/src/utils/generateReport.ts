...
export async function generateDamageReport(data: ReportData): Promise<void> {
  ...
  doc.setFontSize(8);
  doc.setFont("helvetica", "normal");
  doc.text("University of South Asia — Department of Computer Science", W - margin, 24, { align: "right" });
  ...
  const disclaimer =
    ...
    "The University of South Asia and ScreenAI project team are not liable for any decisions made based on this report.";
